...
void calculateWPMAndAccuracy(){
	...
	std::cout<<"\033["<<round(size.ws_row/2.0)-3<<";"<<round(size.ws_col/2.0)-30<<"f"<<"\033[38;5;45mWPM: \033[0m"<<wpm<<"\t\t"<<"\033[38;5;45mAccuracy: \033[0m"<<accuracy<<"%\t\t"<<"\033[38;5;45mTime: \033[0m"<<secondsTest<<"s"<<std::endl;
